...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    # Linux
    sudo cp target/cellery-0.1.1-SNAPSHOT.jar /usr/lib/ballerina/ballerina-${BALLERINA_VERSION}/bre/lib
    ...
    # MacOS
    sudo cp  target/cellery-0.1.1-SNAPSHOT.jar /Library/Ballerina/ballerina-${BALLERINA_VERSION}/bre/lib
