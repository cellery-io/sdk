...
public class HRTest implements SampleTest {
    private static final Path SOURCE_DIR_PATH = SAMPLE_DIR.resolve("employee-portal/cellery/hr");
    ...
    public void compileSample() throws IOException, InterruptedException {
        Assert.assertEquals(KubernetesTestUtils.compileBallerinaFile(SOURCE_DIR_PATH, "hr.bal",
        ...
        cell = cellObj.getInstance(CELLERY_PATH.resolve("test-img12.yaml").toString());
    }
    ...
    public void validateMetaData() {
        ...
        Assert.assertEquals(cell.getMetadata().getAnnotations().get("mesh.cellery.io/cell-image-name"), "test-img12");
